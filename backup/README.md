...
There was a positive correlation observed between alcohol concentration and quality. It is possible that this is due to the alcohol's ability to deliver dissolved volatiles to the nose. It is recommended to further investigate the alcohol content's correlation with other attributes of the wine to determine if there is a link to quality. For this, scatter plots or heat maps will be used as it is 2D data. 